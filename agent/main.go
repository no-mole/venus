...
func main() {
	...
	rootCmd.PersistentFlags().StringVar(&grpcEndpoint, "grpc-endpoint", "0.0.0.0:6233", "grpc endpoint")
	rootCmd.PersistentFlags().StringVar(&httpEndpoint, "http-endpoint", "0.0.0.0:7233", "grpc endpoint")
